...
SK_API_C void sk_canvas_unref(sk_canvas_t*);
...
*/
SK_API_C int sk_canvas_save(sk_canvas_t*);
/**
    ...
    @param sk_paint_t* (may be null) The paint is copied, and is applied
                       ...
                       called.
*/
SK_API_C int sk_canvas_save_layer(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
/**
...
*/
SK_API_C void sk_canvas_restore(sk_canvas_t*);
/**
    Preconcat the current coordinate transformation matrix with the
    specified translation.
*/
SK_API_C void sk_canvas_translate(sk_canvas_t*, float dx, float dy);
/**
    Preconcat the current coordinate transformation matrix with the
    specified scale.
*/
SK_API_C void sk_canvas_scale(sk_canvas_t*, float sx, float sy);
/**
    Preconcat the current coordinate transformation matrix with the
    specified rotation in degrees.
*/
SK_API_C void sk_canvas_rotate_degrees(sk_canvas_t*, float degrees);
/**
    Preconcat the current coordinate transformation matrix with the
    specified rotation in radians.
*/
SK_API_C void sk_canvas_rotate_radians(sk_canvas_t*, float radians);
/**
    Preconcat the current coordinate transformation matrix with the
    specified skew.
*/
SK_API_C void sk_canvas_skew(sk_canvas_t*, float sx, float sy);
/**
    Preconcat the current coordinate transformation matrix with the
    specified matrix.
*/
SK_API_C void sk_canvas_concat(sk_canvas_t*, const sk_matrix_t*);
...
/**
    ...
    rectange.
*/
SK_API_C void sk_canvas_clip_rect(sk_canvas_t*, const sk_rect_t*);
SK_API_C void sk_canvas_clip_region(sk_canvas_t* canvas, const sk_region_t* region, sk_clipop_t op);
/**
    Modify the current clip with the specified path.  The new
    current clip will be the intersection of the old clip and the
    path.
*/
SK_API_C void sk_canvas_clip_path(sk_canvas_t*, const sk_path_t*);

/**
    Fill the entire canvas (restricted to the current clip) with the
    specified paint.
*/
SK_API_C void sk_canvas_draw_paint(sk_canvas_t*, const sk_paint_t*);
/**
    Draw the specified rectangle using the specified paint. The
    rectangle will be filled or stroked based on the style in the
    paint.
*/
SK_API_C void sk_canvas_draw_rect(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
/**
 ...
 */
SK_API_C void sk_canvas_draw_circle(sk_canvas_t*, float cx, float cy, float rad, const sk_paint_t*);
/**
    Draw the specified oval using the specified paint. The oval will be
    filled or framed based on the style in the paint
*/
SK_API_C void sk_canvas_draw_oval(sk_canvas_t*, const sk_rect_t*, const sk_paint_t*);
/**
    Draw the specified path using the specified paint. The path will be
    filled or framed based on the style in the paint
*/
SK_API_C void sk_canvas_draw_path(sk_canvas_t*, const sk_path_t*, const sk_paint_t*);
/**
...
*/
SK_API_C void sk_canvas_draw_image(sk_canvas_t*, const sk_image_t*,
...
/**
    ...
    @param sk_paint_t* (may be NULL) The paint used to draw the image.
*/
SK_API_C void sk_canvas_draw_image_rect(sk_canvas_t*, const sk_image_t*,
                                      const sk_rect_t* src,
...
*/
SK_API_C void sk_canvas_draw_picture(sk_canvas_t*, const sk_picture_t*,
 ...
 */
SK_API_C void sk_canvas_clear(sk_canvas_t*, sk_color_t);
/**
...
*/
SK_API_C void sk_canvas_discard(sk_canvas_t*);
/**
    Returns the number of matrix/clip states on the SkCanvas' private stack.
    This will equal # save() calls - # restore() calls + 1. The save count on
    a new canvas is 1.
*/
SK_API_C int sk_canvas_get_save_count(sk_canvas_t*);
/**
    ...
    pass saveCount == 1.
*/
SK_API_C void sk_canvas_restore_to_count(sk_canvas_t*, int saveCount);
/**
    Draws with the specified color and mode.
**/
SK_API_C void sk_canvas_draw_color(sk_canvas_t* ccanvas, sk_color_t color, sk_blendmode_t mode);
/**
...
*/
SK_API_C void sk_canvas_draw_points(sk_canvas_t*, sk_point_mode_t, size_t, const sk_point_t[], const sk_paint_t*);
/**
   Draws a single point with the specified paint
*/
SK_API_C void sk_canvas_draw_point(sk_canvas_t*, float, float, const sk_paint_t*);
/**
   Draws a single point with the specified paint
*/
SK_API_C void sk_canvas_draw_point_color(sk_canvas_t*, float, float, sk_color_t);
/**
   Draws a line from x0,y0 to x1,y1
*/
SK_API_C void sk_canvas_draw_line(sk_canvas_t* ccanvas, float x0, float y0, float x1, float y1, sk_paint_t* cpaint);
/**
...
*/
SK_API_C void sk_canvas_draw_text (sk_canvas_t*, const char *text, size_t byteLength, float x, float y, const sk_paint_t* paint);
/**
    ...
    @param paint    The paint used for the text (e.g. color, size, style)
*/
SK_API_C void sk_canvas_draw_pos_text (sk_canvas_t*, const char *text, size_t byteLength, const sk_point_t[], const sk_paint_t* paint);
/**
...
*/
SK_API_C void sk_canvas_draw_text_on_path (sk_canvas_t*, const char *text, size_t byteLength, const sk_path_t*path, float hOffset, float vOffset, const sk_paint_t* paint);
/** 
...
*/
SK_API_C void sk_canvas_draw_bitmap(sk_canvas_t* ccanvas, const sk_bitmap_t* bitmap, float left, float top, const sk_paint_t* paint);
/** Draw the specified bitmap, scaling and translating so that it fills the specified
    ...
    @param paint      The paint used to draw the bitmap, or NULL
*/
SK_API_C void sk_canvas_draw_bitmap_rect(sk_canvas_t* ccanvas, const sk_bitmap_t* bitmap, const sk_rect_t* src, const sk_rect_t* dst, const sk_paint_t* paint);
/**
    Helper for setMatrix(identity). Sets the current matrix to identity.
*/
SK_API_C void sk_canvas_reset_matrix(sk_canvas_t* ccanvas);
/**
    Replace the current matrix with a copy of the specified matrix.

    @param matrix The matrix that will be copied into the current matrix.
*/
SK_API_C void sk_canvas_set_matrix(sk_canvas_t* ccanvas, const sk_matrix_t* matrix);
/**
...
*/
SK_API_C void sk_canvas_get_total_matrix(sk_canvas_t* ccanvas, sk_matrix_t* matrix);
/**
    Draw the specified rounded rectangle using the specified paint. The
    rectangle will be filled or stroked based on the style in the
    paint.
*/
SK_API_C void sk_canvas_draw_round_rect(sk_canvas_t*, const sk_rect_t*, float rx, float ry, const sk_paint_t*);
/**
    Modify the current clip with the specified rectangle.
*/
SK_API_C void sk_canvas_clip_rect_with_operation(sk_canvas_t* t, const sk_rect_t* crect, sk_clipop_t op, bool doAA);
/**
    Modify the current clip with the specified path.
*/
SK_API_C void sk_canvas_clip_path_with_operation(sk_canvas_t* t, const sk_path_t* crect, sk_clipop_t op, bool doAA);
...
*/
SK_API_C bool sk_canvas_get_clip_bounds(sk_canvas_t* t, sk_rect_t* cbounds);
/**
    Return the bounds of the current clip, in device coordinates; returns
    true if non-empty. Maybe faster than getting the clip explicitly and
    then taking its bounds.
*/
SK_API_C bool sk_canvas_get_clip_device_bounds(sk_canvas_t* t, sk_irect_t* cbounds);
...
*/
SK_API_C void sk_canvas_flush(sk_canvas_t* ccanvas);

SK_API_C sk_canvas_t* sk_canvas_new_from_bitmap(const sk_bitmap_t* bitmap);

SK_API_C void sk_canvas_draw_bitmap_lattice(sk_canvas_t* t, const sk_bitmap_t* bitmap, const sk_lattice_t* lattice, const sk_rect_t* dst, const sk_paint_t* paint);
SK_API_C void sk_canvas_draw_image_lattice(sk_canvas_t* t, const sk_image_t* image, const sk_lattice_t* lattice, const sk_rect_t* dst, const sk_paint_t* paint);
