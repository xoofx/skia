...
*/
SK_API_C sk_colortype_t sk_colortype_get_default_8888();
...
*/
SK_API_C sk_surface_t* sk_surface_new_raster(const sk_imageinfo_t*, const sk_surfaceprops_t*);
...
/**
    ...
    @param sk_surfaceprops_t* If not NULL, specify additional non-default
                              properties of the surface.
*/
SK_API_C sk_surface_t* sk_surface_new_raster_direct(const sk_imageinfo_t*, void* pixels, size_t rowBytes, const sk_surfaceprops_t* props);
...
*/
SK_API_C void sk_surface_unref(sk_surface_t*);
 ...
 */
SK_API_C sk_canvas_t* sk_surface_get_canvas(sk_surface_t*);

/**
 *  Call sk_image_unref() when the returned image is no longer used.
 */
SK_API_C sk_image_t* sk_surface_new_image_snapshot(sk_surface_t*);
 ...
 */
SK_API_C sk_surface_t* sk_surface_new_backend_render_target(gr_context_t* context, const gr_backend_rendertarget_desc_t* desc, const sk_surfaceprops_t* props);
 ...
 *  SkSurface.
 */
SK_API_C sk_surface_t* sk_surface_new_backend_texture(gr_context_t* context, const gr_backend_texture_desc_t* desc, const sk_surfaceprops_t* props);
 ...
 *  SkSurface.
 */
SK_API_C sk_surface_t* sk_surface_new_backend_texture_as_render_target(gr_context_t* context, const gr_backend_texture_desc_t* desc, const sk_surfaceprops_t* props);

SK_API_C sk_surface_t* sk_surface_new_render_target(gr_context_t* context, bool budgeted, const sk_imageinfo_t* info, int sampleCount, const sk_surfaceprops_t* props);
