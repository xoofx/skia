...
*/
SK_API_C sk_picture_recorder_t* sk_picture_recorder_new();
/**
    Release the memory and other resources used by this
    sk_picture_recorder_t.
*/
SK_API_C void sk_picture_recorder_delete(sk_picture_recorder_t*);
...
*/
SK_API_C sk_canvas_t* sk_picture_recorder_begin_recording(sk_picture_recorder_t*, const sk_rect_t*);
/**
...
*/
SK_API_C sk_picture_t* sk_picture_recorder_end_recording(sk_picture_recorder_t*);

SK_API_C sk_canvas_t* sk_picture_get_recording_canvas(sk_picture_recorder_t* crec);

/**
    Increment the reference count on the given sk_picture_t. Must be
    balanced by a call to sk_picture_unref().
*/
SK_API_C void sk_picture_ref(sk_picture_t*);
/**
...
*/
SK_API_C void sk_picture_unref(sk_picture_t*);

/**
    Returns a non-zero value unique among all pictures.
 */
SK_API_C uint32_t sk_picture_get_unique_id(sk_picture_t*);

/**
    Return the cull rect specified when this picture was recorded.
*/
SK_API_C sk_rect_t sk_picture_get_bounds(sk_picture_t*);
