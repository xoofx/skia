 ...
 */
SK_API_C sk_image_t* sk_image_new_raster_copy(const sk_imageinfo_t*, const void* pixels, size_t rowBytes);
/**
 ...
 *  use.
 */
SK_API_C sk_image_t* sk_image_new_from_encoded(const sk_data_t* encoded, const sk_irect_t* subset);
/**
...
*/
SK_API_C void sk_image_unref(const sk_image_t*);
/**
 *  Return the width of the sk_image_t/
 */
SK_API_C int sk_image_get_width(const sk_image_t*);
/**
 *  Return the height of the sk_image_t/
 */
SK_API_C int sk_image_get_height(const sk_image_t*);
/**
 *  Returns a non-zero value unique among all images.
 */
SK_API_C uint32_t sk_image_get_unique_id(const sk_image_t*);
/**
 ...
 *  If the image type cannot be encoded, this will return NULL.
 */
SK_API_C sk_data_t* sk_image_encode_specific(const sk_image_t* cimage, sk_image_encoder_t encoder, int quality);
/**
 ...
 */
SK_API_C sk_image_t* sk_image_new_from_bitmap (const sk_bitmap_t *cbitmap);
