...
SK_API_C void sk_shader_ref(sk_shader_t*);
SK_API_C void sk_shader_unref(sk_shader_t*);
...
*/
SK_API_C sk_shader_t* sk_shader_new_linear_gradient(const sk_point_t points[2],
...
*/
SK_API_C sk_shader_t* sk_shader_new_radial_gradient(const sk_point_t* center,
                                           float radius,
                                           const sk_color_t colors[],
                                           const float colorPos[],
                                           int colorCount,
...
/**
    ...
    @param localMatrix May be NULL
*/
SK_API_C sk_shader_t* sk_shader_new_sweep_gradient(const sk_point_t* center,
                                          const sk_color_t colors[],
                                          const float colorPos[],
                                          int colorCount,
                                          const sk_matrix_t* localMatrix);
...
*/
SK_API_C sk_shader_t* sk_shader_new_two_point_conical_gradient(
...
*/
SK_API_C sk_shader_t* sk_shader_new_empty();
/**
...
*/
SK_API_C sk_shader_t* sk_shader_new_color(sk_color_t color);
/** 
...
*/
SK_API_C sk_shader_t* sk_shader_new_bitmap(const sk_bitmap_t* src,
                                         sk_shader_tilemode_t tmx,
                                         sk_shader_tilemode_t tmy,
                                         const sk_matrix_t* localMatrix);
SK_API_C sk_shader_t* sk_shader_new_picture(sk_picture_t* src,
                                         sk_shader_tilemode_t tmx,
                                         sk_shader_tilemode_t tmy,
                                         const sk_matrix_t* localMatrix,
...
*/
SK_API_C sk_shader_t* sk_shader_new_local_matrix(sk_shader_t* proxy,
                                               const sk_matrix_t* localMatrix);
SK_API_C sk_shader_t* sk_shader_new_color_filter(sk_shader_t* proxy,
                                               sk_colorfilter_t* filter);
SK_API_C sk_shader_t* sk_shader_new_perlin_noise_fractal_noise(
    float baseFrequencyX,
    float baseFrequencyY,
    int numOctaves,
    float seed,
    const sk_isize_t* tileSize);
SK_API_C sk_shader_t* sk_shader_new_perlin_noise_turbulence(
    float baseFrequencyX,
    float baseFrequencyY,
    int numOctaves,
    float seed,
    const sk_isize_t* tileSize);
SK_API_C sk_shader_t* sk_shader_new_compose(
    sk_shader_t* shaderA,
    sk_shader_t* shaderB);
SK_API_C sk_shader_t* sk_shader_new_compose_with_mode(
    sk_shader_t* shaderA,
    sk_shader_t* shaderB,
